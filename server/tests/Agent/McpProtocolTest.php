 ...
 *   - tools/list 断言数量为 60（开源版实际工具数：原 58 + 新增 search_help_docs + 新增 get_recent_changes；旧断言 53 为历史遗留未随工具增加更新）
 */
class McpProtocolTest extends TestCase
{
    ...
    /**
     * TC-090.2 tools/list 返回全部 60 个工具
     */
    public function testToolsListReturnsAllTools(): void
    {
        ...
        $this->assertCount(60, $resp['result']['tools']);
